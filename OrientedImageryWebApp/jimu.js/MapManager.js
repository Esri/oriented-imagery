...
define([
  ...
  './PopupManager',
  './FilterManager'
], function(declare, lang, array, html, query, topic, on, aspect, keys, i18n,domStyle, dojoConfig, InfoWindow,
    ...
    clazz = declare(null, {
      ...
      _show2DWebMap: function(appConfig) {
        ...
        // }
         ...
         domStyle.set(document.getElementById("map"),"left","26.5%");
     }
     }
