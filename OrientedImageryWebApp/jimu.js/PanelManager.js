...
define(['dojo/_base/declare',
  ...
  './utils',
  './WidgetManager'],
function (declare, lang, array, html, baseFx, Deferred, all, on,aspect, topic, when,
  ...
  clazz = declare(null, {
    ...
    showPanel: function(config){
      ...
      if(panel){
        ...
        if(panel.id !== "_8_panel" && panel.id !== "_29_panel"){
            
        html.setStyle(panel.domNode, 'opacity', 0);
          aspect.before(panel, 'destroy', lang.hitch(this, this.onDestroyPanel, panel));
          html.setStyle(panel.domNode, 'width', '0px');
          html.setStyle(panel.domNode, 'height', '0px');
        }
